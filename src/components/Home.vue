   ...
   <div style="width:100%">
     <div class="preloader">
        <div id="main">
                <header id="header">
                    <div class="wrap">
                        <h1><img src="/static/logo2.PNG" alt="logo" style="width:250px;height:150px;"></h1>
                    </div>
                </header>
                <br><br><br>
                <section id="contents">
     ...
     <div class="application app">
       ...
       <div class="full-nav">
           <div class="logo">
               <a href=""><img class="mylogo" src="/static/logo3.png" alt=""/></a>
           </div>
           <!--
          <nav class="nav2">
               <ul>
...
<script>
import "../assets/jquery.bxslider.css"
...
import Parteners from './HomeComponents/Parteners'
...
.preloader #main #header{
    display:flex;
    justify-content:center;
    padding:70px 0;
    text-align:center;
}
.preloader #main #header h1{
  position:relative;
}
.preloader #main #header h1:before {
   content:"";
   width:40px;
   height:2px;
...
.preloader #main #header h1:after {
   content:"";
   width:40px;
   height:2px;
   background-color:white;
...
.preloader #main #contents .loader{
    padding:20px 0;;
}
.preloader #main #contents .loader .load{
   background:orangered;
}
.preloader #main #contents .loader .load .percentage{
   background-color:white;
   height:10px;
}
.preloader #main #contents .loader .info{
     display:flex;
     font-size:18px;

}
.preloader #main #contents .loader .info span{
    flex:1;
     
}
.preloader #main #contents .loader .info span:first-child{
    text-align:left;
     
}
.preloader #main #contents .loader .info span:last-child{
    text-align:right;
     
}

.preloader #main #contents .wrap{
    font-family:'Oswald';
    font-weight:bold;
    text-align:center;
    font-size:18px;
...
.preloader #main footer .social-links{
    display:flex;
    justify-content:center;
}
.preloader #main footer .social-links a{
    display:flex;
    justify-content:center;
    align-items:center;
    margin-right:7px;
...
.preloader #main footer .social-links a:hover{
 color:black;
...
.social-icons a:hover{
    color:white!important;
   background-image:linear-gradient(25deg,#00D320,#00D320);
