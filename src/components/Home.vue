...
components:{Price,Portfolio,Events,Parteners,TopBar,Footer,Contact,Parallax,Parallax2,Clients,UAnimateContainer, UAnimate},
   data(){
        return{
...
@media only screen and (min-width: 701px) and (max-width: 1203px){
   .vidContent h1{
       font-size:2em;
   }
   .vidContent{
