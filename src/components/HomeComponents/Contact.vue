 ...
 <section class="contact" id="contact">
  ...
  <div class="map-content">
   ...
   <div data-aos="fade-right" class="contact-form">
     <div class="card">
       <span data-aos="flip-right" class="card-title">Contact us</span>
       <div class="card-content">
         <form>
           ...
           <a data-aos="flip-right" data-aos-delay="600" href="#" class="btn waves-effect">send</a>
         </form>
       </div>
    </div>
  </div>
...
function initMap() {
    ...
    var uluru = {lat:  36.7052 , lng: 4.1916 };
    var mapCenter = {lat: 36.7525 , lng:  3.04197};
    ...
    var contentString = '<div class="maptooltip center" id="content">'+
        ...
        '<h6 id="firstHeading" class="firstHeading">Tamda,Algeria</h6>'+
        '<div id="bodyContent">'+
        '<em>SAM K TRAVEL & TOUR</em>'+
        '</div>'+
        '</div>';
